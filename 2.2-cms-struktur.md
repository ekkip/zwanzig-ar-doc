...
| :------------- | :------------- |
| ![Self-contained](/img/pe_self_contained.png)       | ![Self-contained](/img/pe_self_contained.png)       |
| Medientyp: 3D-Datei; `.usdz`, `.scn`       | Medientyp: Foto; `.jpg`, `.png`      |
...
Paper:
Empfohlene Größe: max. 4 Megapixel; mehr ist nicht notwendig auf
